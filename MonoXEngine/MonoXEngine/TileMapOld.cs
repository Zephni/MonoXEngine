...
namespace MonoXEngine
{
    public class TileMapOld
    {
        ...
        public TileMapOld(Point tileSize, string tilesetFile = null, List<Tile> tiles = null)
        {
            this.Tiles = new List<Tile>();
            this.TileSize = tileSize;

            if (tilesetFile != null)
                this.LoadTileset(tilesetFile);

            if (tiles != null)
                this.SetTiles(tiles);

            if (this.Tileset != null && this.Tiles != null)
                this.BuildEntities();
        }
        ...
        public void BuildEntities()
        {
            ...
            {
                tileList.Add(new Entity(entity =>
                {
